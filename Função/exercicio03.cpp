...
template <size_t M, size_t N>
bool vagaOcupada(const int (&estacionamento)[M][N], int vaga);
        ...
        switch(opcao){
            ...
            case 2:
                ...
                if(vagaValida(vaga, estacionamento)){
                    ...
                    if(!vagaOcupada(estacionamento, vaga)){
                        ocuparVaga(estacionamento, vaga);
                        cout << "Vaga " << vaga << " ocupada com sucesso.\n";
                    } else {
            ...
            case 3:
                ...
                if(vagaValida(vaga, estacionamento)){
                    ...
                    if(vagaOcupada(estacionamento, vaga)){
                        ...
                        cout << "Vaga " << vaga << " liberada com sucesso.\n";
                    } else {
            ...
            case 4:
                cout << "Número de vagas livres: " << contarVagasLivres(estacionamento) << endl;
                break;
            ...
            case 5:
                ...
                if(linha >= 1 and linha <= 4){
                    cout << "Número de vagas livres da linha " << linha << ": " << contarVagasLivres(estacionamento, linha - 1) << endl;
                } else {
...
bool vagaOcupada(const int (&estacionamento)[M][N], int vaga){
    int linha = (vaga - 1) / N;
    int coluna = (vaga - 1) % N;
    return estacionamento[linha][coluna] == 1;
}
